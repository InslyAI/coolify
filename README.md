...
Coolify is an open-source & self-hostable platform that lets you deploy applications, databases, and services on your own servers with just a few clicks.
...
1. **Connect Your Server**: Add any server with SSH access - VPS, bare metal, or even Raspberry Pi
2. **Deploy Resources**: Use the intuitive UI to deploy applications and databases
3. **Automatic Configuration**: Coolify handles Docker containers, reverse proxy setup, SSL certificates, and networking
...
## Maintained by Insly.ai

This fork is actively maintained by [Insly.ai](https://insly.ai) to support our infrastructure needs and contribute back to the open-source community.